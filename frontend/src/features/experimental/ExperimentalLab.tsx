...
const experiments: ExperimentInfo[] = [
  ...
  },
  {
    ...
    name: 'Silence Echo',
    icon: Ghost,
    description: 'When you stop moving, a faint afterimage remains. Memories of interaction.',
    color: '#7B68EE'
  },
  {
    id: 'drift',
...
export const ExperimentalLab: React.FC = () => {
  ...
  const renderCanvas = () => {
    switch (activeExperiment) {
      ...
      case 'echo':
        return <ExperimentalCanvas color={selectedColor} mode="echo" />;
      case 'drift':
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  {activeExperiment === 'echo' && (
                    <>
                      <p>• Be still for a moment, then move</p>
                      <p>• Each interaction leaves a visual trace</p>
                      <p>• Traces slowly fade like memories</p>
                    </>
                  )}
